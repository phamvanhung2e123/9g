<?php /* Smarty version 2.6.6, created on 2013-08-14 22:19:08
         compiled from administrator/stories_manage.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'administrator/stories_manage.tpl', 89, false),array('modifier', 'truncate', 'administrator/stories_manage.tpl', 102, false),array('modifier', 'date_format', 'administrator/stories_manage.tpl', 104, false),)), $this); ?>
                                ...
                                <div id="isoft_group_1_content" style="display:none;">
                                	<div class="entry-edit">
                                        <div class="entry-edit-head">
                                            <h4 class="icon-head head-edit-form fieldset-legend">Manage Gags</h4>
 ...
 Gags
            				...
            				<td class="filter-actions a-right">
                            	<button  id="id_ffba3971e132ae3d78c160244ea09b39" type="button" class="scalable " onclick="document.location.href='stories_manage.php'" style=""><span>Reset Filter</span></button>
...
">Edit</a>&nbsp;|&nbsp;<a href="stories_manage.php?page=<?php echo $this->_tpl_vars['currentpage']; ?>
...
unset($_smarty_tpl_vars);
 ?>
                            ...
                            <div class="content-header">
                               <h3 class="icon-head head-products">Gags - Manage Gags</h3>
                            </div>
