<?php /* Smarty version 2.6.6, created on 2013-08-14 22:19:20
...
&$toid=<?php echo $this->_tpl_vars['toid']; ?>
&details=<?php echo $this->_tpl_vars['details']; ?>
&active=<?php echo $this->_tpl_vars['active'];  endif; ?>" name="details" class="<?php if ($this->_tpl_vars['sortby'] == 'details'): ?>sort-arrow-<?php if ($this->_tpl_vars['sorthow'] == 'desc'): ?>desc<?php else: ?>asc<?php endif;  else: ?>not-sort<?php endif; ?>"><span class="sort-title">Description</span></a></span></th>
                                        <th ><span class="nobr"><a href="ads_manage.php?page=<?php echo $this->_tpl_vars['currentpage']; ?>
