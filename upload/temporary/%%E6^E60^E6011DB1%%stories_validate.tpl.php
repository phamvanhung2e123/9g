<?php /* Smarty version 2.6.6, created on 2013-08-10 23:01:21
         compiled from administrator/stories_validate.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'administrator/stories_validate.tpl', 104, false),array('modifier', 'truncate', 'administrator/stories_validate.tpl', 119, false),array('modifier', 'date_format', 'administrator/stories_validate.tpl', 124, false),)), $this); ?>
                                ...
                                <div id="isoft_group_2_content" style="display:none;">
                                	<div class="entry-edit">
                                        <div class="entry-edit-head">
                                            <h4 class="icon-head head-edit-form fieldset-legend">Validate Gags</h4>
 ...
 Gags
            				...
            				<td class="filter-actions a-right">
                            	<button  id="id_ffba3971e132ae3d78c160244ea09b39" type="button" class="scalable " onclick="document.location.href='stories_validate.php'" style=""><span>Reset Filter</span></button>
...
&details=<?php echo $this->_tpl_vars['details']; ?>
&username=<?php echo $this->_tpl_vars['username']; ?>
&active=<?php echo $this->_tpl_vars['active'];  endif; ?>" name="details" class="<?php if ($this->_tpl_vars['sortby'] == 'details'): ?>sort-arrow-<?php if ($this->_tpl_vars['sorthow'] == 'desc'): ?>desc<?php else: ?>asc<?php endif;  else: ?>not-sort<?php endif; ?>"><span class="sort-title">Title</span></a></span></th>
                                        <th ><span class="nobr"><a href="stories_validate.php?page=<?php echo $this->_tpl_vars['currentpage']; ?>
...
&details=<?php echo $this->_tpl_vars['details']; ?>
&username=<?php echo $this->_tpl_vars['username']; ?>
&active=<?php echo $this->_tpl_vars['active'];  endif; ?>" name="mod_yes" class="<?php if ($this->_tpl_vars['sortby'] == 'mod_yes'): ?>sort-arrow-<?php if ($this->_tpl_vars['sorthow'] == 'desc'): ?>desc<?php else: ?>asc<?php endif;  else: ?>not-sort<?php endif; ?>"><span class="sort-title">Yes Votes</span></a></span></th>
                                        <th ><span class="nobr"><a href="stories_validate.php?page=<?php echo $this->_tpl_vars['currentpage']; ?>
...
&details=<?php echo $this->_tpl_vars['details']; ?>
&username=<?php echo $this->_tpl_vars['username']; ?>
&active=<?php echo $this->_tpl_vars['active'];  endif; ?>" name="mod_no" class="<?php if ($this->_tpl_vars['sortby'] == 'mod_no'): ?>sort-arrow-<?php if ($this->_tpl_vars['sorthow'] == 'desc'): ?>desc<?php else: ?>asc<?php endif;  else: ?>not-sort<?php endif; ?>"><span class="sort-title">No Votes</span></a></span></th>
                                        <th ><span class="nobr"><a href="stories_validate.php?page=<?php echo $this->_tpl_vars['currentpage']; ?>
...
&details=<?php echo $this->_tpl_vars['details']; ?>
&username=<?php echo $this->_tpl_vars['username']; ?>
&active=<?php echo $this->_tpl_vars['active'];  endif; ?>" name="username" class="<?php if ($this->_tpl_vars['sortby'] == 'username'): ?>sort-arrow-<?php if ($this->_tpl_vars['sorthow'] == 'desc'): ?>desc<?php else: ?>asc<?php endif;  else: ?>not-sort<?php endif; ?>"><span class="sort-title">Owner</span></a></span></th>
                                        <th ><span class="nobr"><a href="stories_validate.php?page=<?php echo $this->_tpl_vars['currentpage']; ?>
...
&details=<?php echo $this->_tpl_vars['details']; ?>
&username=<?php echo $this->_tpl_vars['username']; ?>
&active=<?php echo $this->_tpl_vars['active'];  endif; ?>" name="time_added" class="<?php if ($this->_tpl_vars['sortby'] == 'time_added'): ?>sort-arrow-<?php if ($this->_tpl_vars['sorthow'] == 'desc'): ?>desc<?php else: ?>asc<?php endif;  else: ?>not-sort<?php endif; ?>"><span class="sort-title">Date Added</span></a></span></th>
...
unset($_smarty_tpl_vars);
 ?>
                            ...
                            <div class="content-header">
                               <h3 class="icon-head head-products">Gags - Validate Gags</h3>
                            </div>
